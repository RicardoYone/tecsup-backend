    ...
    def update(self, request, pk):
        ...
        if isinstance(resultado, Response):
            ...
            return Response(data={
                ...
                # dataSerializada.data # va a ser la informacion que he pasado al momento de llamar al serializador
...
def usandoVista(request):
    ...
    # Con parametros
    cursor.execute(
        'SELECT * FROM listar_etiquetas_con_la_letra_A where id = %s and deleted= %s', [4, True])
    # Sin parametros
