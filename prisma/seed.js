//El seed sirve para alimentar nuestra db con determinada informacion que nunca va acambiar tmb se utiliza para crear data de prueba
import prisma from "@prisma/client";

//const prisma=requiere('@prisma/client')
const { PrismaClient } = prisma;
const conexion = new PrismaClient();

async function alimentar() {
  console.log("Iniciando el sedding");
  ...
  await conexion.region.createMany({
    ...
    skipDuplicates: true, //SALTAR DUPLICADOS
  });
